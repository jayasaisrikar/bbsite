        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://facebook.com/BlocksBridge"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-600"
                aria-label="BlocksBridge on Facebook (opens in a new tab)"
                title="BlocksBridge on Facebook"
              >
                <Facebook className="w-5 h-5" />
              </a>
              <a
                href="https://linkedin.com/company/blocksbridge"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-600"
                aria-label="BlocksBridge on LinkedIn (opens in a new tab)"
                title="BlocksBridge on LinkedIn"
              >
                <Linkedin className="w-5 h-5" />
              </a>
              <a
                href="https://x.com/BlocksBridge_"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-600"
                aria-label="BlocksBridge on X (opens in a new tab)"
                title="BlocksBridge on X"
              >
